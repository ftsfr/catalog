# Dataframe: `crsp_treasury:treasury_auctions` - treasury_auctions
...
Columns: 123
$ cusip                                                       <str> '912827KC5'
$ issueDate                                          <datetime[ns]> 1979-11-15 00:00:00
$ securityType                                                <str> 'Note'
$ securityTerm                                                <str> '10-Year'
$ maturityDate                                       <datetime[ns]> 1989-11-15 00:00:00
$ interestRate                                                <f64> 10.75
$ refCpiOnIssueDate                                           <str> ''
$ refCpiOnDatedDate                                           <str> ''
$ announcementDate                                   <datetime[ns]> 1979-10-24 00:00:00
$ auctionDate                                        <datetime[ns]> 1979-10-31 00:00:00
$ auctionDateYear                                             <str> '1979'
$ datedDate                                          <datetime[ns]> 1979-11-15 00:00:00
$ accruedInterestPer1000                                      <f64> 0.0
$ accruedInterestPer100                                       <f64> None
$ adjustedAccruedInterestPer1000                              <f64> None
$ adjustedPrice                                               <f64> None
$ allocationPercentage                                        <f64> 99.0
$ allocationPercentageDecimals                                <str> '0'
$ announcedCusip                                              <str> ''
$ auctionFormat                                               <str> 'Multi-Price'
$ averageMedianDiscountRate                                   <f64> None
$ averageMedianInvestmentRate                                 <f64> None
$ averageMedianPrice                                          <f64> 100.0
$ averageMedianDiscountMargin                                 <str> ''
$ averageMedianYield                                          <str> '10.750000'
$ backDated                                                  <null> None
$ backDatedDate                                      <datetime[ns]> None
$ bidToCoverRatio                                             <f64> None
$ callDate                                           <datetime[ns]> None
$ callable                                                   <null> None
$ calledDate                                         <datetime[ns]> None
$ cashManagementBillCMB                                      <null> None
$ closingTimeCompetitive                                      <str> ''
$ closingTimeNoncompetitive                                   <str> ''
$ competitiveAccepted                                         <str> ''
$ competitiveBidDecimals                                      <str> '2'
...
$ estimatedAmountOfPubliclyHeldMaturingSecuritiesBy…          <str> ''
$ fimaIncluded                                               <null> None
$ fimaNoncompetitiveAccepted                                  <str> ''
$ fimaNoncompetitiveTendered                                  <str> ''
$ firstInterestPeriod                                         <str> 'Normal'
$ firstInterestPaymentDate                           <datetime[ns]> 1980-05-15 00:00:00
$ floatingRate                                               <null> None
$ frnIndexDeterminationDate                                   <str> ''
$ frnIndexDeterminationRate                                   <str> ''
$ highDiscountRate                                            <str> ''
$ highInvestmentRate                                          <str> ''
$ highPrice                                                   <str> '99.759'
$ highDiscountMargin                                          <str> ''
$ highYield                                                   <str> '10.7900'
$ indexRatioOnIssueDate                                       <str> ''
$ indirectBidderAccepted                                      <str> ''
$ indirectBidderTendered                                      <str> ''
$ interestPaymentFrequency                                    <str> 'Semi-Annual'
$ lowDiscountRate                                             <str> ''
$ lowInvestmentRate                                           <str> ''
$ lowPrice                                                    <str> '100.303'
$ lowDiscountMargin                                           <str> ''
$ lowYield                                                    <str> '10.700000'
$ maturingDate                                       <datetime[ns]> None
...
$ offeringAmount                                              <str> '2000000000'
$ originalCusip                                               <str> ''
$ originalDatedDate                                  <datetime[ns]> None
$ originalIssueDate                                  <datetime[ns]> None
$ originalSecurityTerm                                        <str> '10-Year'
...
$ reopening                                                  <null> None
$ securityTermDayMonth                                        <str> '0-Month'
$ securityTermWeekYear                                        <str> '10-Year'
$ series                                                      <str> 'B-1989'
$ somaAccepted                                                <str> ''
$ somaHoldings                                                <str> ''
$ somaIncluded                                               <null> None
$ somaTendered                                                <str> ''
$ spread                                                      <str> ''
$ standardInterestPaymentPer1000                              <str> '53.7500'
$ strippable                                                 <null> None
$ term                                                        <str> '10-Year'
$ tiinConversionFactorPer1000                                 <str> ''
$ tips                                                       <null> None
$ totalAccepted                                               <f64> 2401000000.0
$ totalTendered                                               <f64> 3818000000.0
$ treasuryRetailAccepted                                      <str> ''
$ treasuryRetailTendersAccepted                               <str> ''
$ type                                                        <str> 'Note'
$ unadjustedAccruedInterestPer1000                            <str> ''
$ unadjustedPrice                                             <str> ''
$ updatedTimestamp                                            <str> '2024-01-09T10:27:11'
$ xmlFilenameAnnouncement                                     <str> ''
$ xmlFilenameCompetitiveResults                               <str> ''
$ xmlFilenameSpecialAnnouncement                              <str> ''
$ tintCusip1                                                  <str> ''
$ tintCusip2                                                  <str> ''
$ tintCusip1DueDate                                  <datetime[ns]> None
$ tintCusip2DueDate                                  <datetime[ns]> None
$ run                                                         <i64> 0
$ runness_term                                                <str> None
$ runness_type                                                <str> None
...
| Dataframe Name                 | treasury_auctions                                                   |
|--------------------------------|--------------------------------------------------------------------------------------|
| Dataframe ID                   | [treasury_auctions](../dataframes/crsp_treasury/treasury_auctions.md)                                       |
| Data Sources                   | treasury_auction_stats                                        |
| Data Providers                 | TreasuryDirect                                      |
| Links to Providers             | https://treasurydirect.gov/TA_WS/securities/jqsearch                             |
| Topic Tags                     | Treasuries, Auctions                                          |
| Type of Data Access            | Web API                                  |
| How is data pulled?            | TreasuryDirect Web API, runness calculated from auction data and merged by CUSIP and auction date                                                    |
| Data available up to (min)     | 1984-11-08 00:00:00                                                             |
| Data available up to (max)     | 2026-01-21 00:00:00                                                             |
| Dataframe Path                 | /Users/jbejarano/GitRepositories/ftsfr_repos/crsp_treasury/_data/treasury_auctions.parquet                                                   |
| Download Data as Parquet       | [Parquet](../../download_dataframe/crsp_treasury/treasury_auctions.parquet)         |
| Download Data as Excel         | [Excel](../../download_dataframe/crsp_treasury/treasury_auctions.xlsx)              |
| Linked Charts                  |  None  |
