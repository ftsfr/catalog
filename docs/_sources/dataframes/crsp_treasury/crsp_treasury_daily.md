# Dataframe: `crsp_treasury:crsp_treasury_daily` - crsp_treasury_daily

CRSP Treasury Data with Runness

## Overview

This dataset combines comprehensive U.S. Treasury daily price and yield data from CRSP (Center for Research in Security Prices) with auction-based runness calculations. It provides a complete historical time series of Treasury securities with accurate on-the-run vs off-the-run classification.
...
Rows: 2522876
Columns: 26
$ kytreasno                  <f64> 200695.0
$ kycrspid                   <str> '19701115.205000'
$ tcusip                     <str> '912827AJ'
$ caldt             <datetime[ns]> 1970-01-02 00:00:00
$ tdatdt            <datetime[ns]> 1966-02-15 00:00:00
$ tmatdt            <datetime[ns]> 1970-11-15 00:00:00
$ tfcaldt           <datetime[ns]> 1970-01-01 00:00:00
$ tdbid                      <f64> 97.15625
$ tdask                      <f64> 97.28125
$ tdaccint                   <f64> 0.66298342541437
$ tdyld                      <f64> 0.00022462008231759
$ tdpubout                   <f64> 6041.0
$ tdtotout                   <f64> 7675.0
$ tdpdint                    <f64> 0.0
$ tcouprt                    <f64> 5.0
...
$ years_to_maturity          <f64> 1.0
$ tdduratn                   <f64> 312.43877115662997
$ tdretnua                   <f64> 0.0009215955254947601
$ days_to_maturity           <i64> 317
$ callable                  <bool> False
$ price_dirty                <f64> 97.88173342541437
$ run                        <i64> 0
$ auction_term              <null> None
$ auction_type              <null> None
...
| Dataframe Name                 | crsp_treasury_daily                                                   |
|--------------------------------|--------------------------------------------------------------------------------------|
| Dataframe ID                   | [crsp_treasury_daily](../dataframes/crsp_treasury/crsp_treasury_daily.md)                                       |
| Data Sources                   | crsp, treasury_auction_stats                                        |
| Data Providers                 | WRDS, TreasuryDirect                                      |
| Links to Providers             |                              |
| Topic Tags                     | Treasuries                                          |
| Type of Data Access            | WRDS,Web API                                  |
| How is data pulled?            | CRSP via WRDS API, runness from TreasuryDirect auction data merged by CUSIP and date                                                    |
| Data available up to (min)     | N/A (large file)                                                             |
| Data available up to (max)     | N/A (large file)                                                             |
| Dataframe Path                 | /Users/jbejarano/GitRepositories/ftsfr_repos/crsp_treasury/_data/crsp_treasury_daily.parquet                                                   |
| Download Data as Parquet       | [Parquet](../../download_dataframe/crsp_treasury/crsp_treasury_daily.parquet)         |
| Download Data as Excel         | [Excel](../../download_dataframe/crsp_treasury/crsp_treasury_daily.xlsx)              |
| Linked Charts                  |  None  |
