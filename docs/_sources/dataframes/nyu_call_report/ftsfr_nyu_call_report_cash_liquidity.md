# Dataframe: `nyu_call_report:ftsfr_nyu_call_report_cash_liquidity` - ftsfr_nyu_call_report_cash_liquidity

## Bank-Level Cash Liquidity

This dataset contains quarterly cash liquidity ratios (Cash / Total Assets) for individual banks.
...
| Dataframe Name                 | ftsfr_nyu_call_report_cash_liquidity                                                   |
|--------------------------------|--------------------------------------------------------------------------------------|
| Dataframe ID                   | [ftsfr_nyu_call_report_cash_liquidity](../dataframes/nyu_call_report/ftsfr_nyu_call_report_cash_liquidity.md)                                       |
...
| Dataframe Path                 | /Users/jbejarano/GitRepositories/ftsfr_repos/nyu_call_report/_data/ftsfr_nyu_call_report_cash_liquidity.parquet                                                   |
| Download Data as Parquet       | [Parquet](../../download_dataframe/nyu_call_report/ftsfr_nyu_call_report_cash_liquidity.parquet)         |
| Download Data as Excel         | [Excel](../../download_dataframe/nyu_call_report/ftsfr_nyu_call_report_cash_liquidity.xlsx)              |
| Linked Charts                  |  None  |
